...
namespace Memory
{
    public partial class Form4 : Form
    {
        ...
        public Form4()
        {
            ...
            squares.Add(new Square(this.button2, Properties.Resources.N2, "DejanGorgievik"));
            squares.Add(new Square(this.button3, Properties.Resources.DimitarTrajanov, "DimitarTrajanov"));
            squares.Add(new Square(this.button4, Properties.Resources.dekan, "DimitarTrajanov"));
            squares.Add(new Square(this.button5, Properties.Resources.GjorgiMadzarov, "GjorgiMadzarov"));
            squares.Add(new Square(this.button6, Properties.Resources.N1, "GjorgiMadzarov"));
            squares.Add(new Square(this.button7, Properties.Resources.TomceDelev, "TomceDelev"));
            squares.Add(new Square(this.button8, Properties.Resources.vizuelno, "TomceDelev"));
            squares.Add(new Square(this.button9, Properties.Resources.AnastasMisev, "AnastasMisev"));
            squares.Add(new Square(this.button10, Properties.Resources.prodekan, "AnastasMisev"));
            squares.Add(new Square(this.button11, Properties.Resources.BoroJakimovski, "BoroJakimovski"));
            squares.Add(new Square(this.button12, Properties.Resources.superK, "BoroJakimovski"));
            squares.Add(new Square(this.button13, Properties.Resources.VericaBakeva, "VericaBakeva"));
            squares.Add(new Square(this.button14, Properties.Resources.cal, "VericaBakeva"));
            squares.Add(new Square(this.button15, Properties.Resources.VladimirTrajkovik, "VladimirTrajkovik"));
            squares.Add(new Square(this.button16, Properties.Resources.algoritmi, "VladimirTrajkovik"));
            squares.Add(new Square(this.button17, Properties.Resources.KaterinaTrojacanec, "KaterinaTrojacanec"));
            squares.Add(new Square(this.button18, Properties.Resources.krs, "KaterinaTrojacanec"));
            squares.Add(new Square(this.button19, Properties.Resources.AnderjGajduk, "AnderjGajduk"));
            squares.Add(new Square(this.button20, Properties.Resources.demonstrator, "AnderjGajduk"));
            squares.Add(new Square(this.button21, Properties.Resources.IvanCorbev, "IvanCorbev"));
            squares.Add(new Square(this.button22, Properties.Resources.vd, "IvanCorbev"));
            squares.Add(new Square(this.button23, Properties.Resources.IvanKitanovski, "IvanKitanovski"));
            squares.Add(new Square(this.button24, Properties.Resources.nrs, "IvanKitanovski"));
         ...
         private void newGame()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                temp.button = squares[i % 24].button;
                squares[i % 24].button = squares[index].button;
