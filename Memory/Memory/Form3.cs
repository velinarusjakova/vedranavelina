...
namespace Memory
{
    public partial class Form3 : Form
    {
        ...
        public Form3()
        {
            ...
            squares.Add(new Square(this.button14, Properties.Resources.VericaBakeva, "VericaBakeva"));
            squares.Add(new Square(this.button15, Properties.Resources.VladimirTrajkovik, "VladimirTrajkovik"));
            squares.Add(new Square(this.button16, Properties.Resources.VladimirTrajkovik, "VladimirTrajkovik"));
            squares.Add(new Square(this.button17, Properties.Resources.KaterinaTrojacanec, "KaterinaTrojacanec"));
            squares.Add(new Square(this.button18, Properties.Resources.KaterinaTrojacanec, "KaterinaTrojacanec"));
            squares.Add(new Square(this.button19, Properties.Resources.AnderjGajduk, "AnderjGajduk"));
            squares.Add(new Square(this.button20, Properties.Resources.AnderjGajduk, "AnderjGajduk"));
            squares.Add(new Square(this.button21, Properties.Resources.IvanCorbev, "IvanCorbev"));
            squares.Add(new Square(this.button22, Properties.Resources.IvanCorbev, "IvanCorbev"));
            squares.Add(new Square(this.button23, Properties.Resources.IvanKitanovski, "IvanKitanovski"));
            squares.Add(new Square(this.button24, Properties.Resources.IvanKitanovski, "IvanKitanovski"));
